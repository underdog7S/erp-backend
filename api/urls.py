...
urlpatterns = [
    ...
    path('team-chat/channels/<int:channel_id>/read/', MarkChannelReadView.as_view(), name='team-chat-mark-read'),
    ...
    # Password Reset
    path('accounting/categories/', accounting_views.CategoryListCreateView.as_view(), name='accounting-categories'),
    ...
    path('users/invite/', users_views.InviteUserView.as_view(), name='invite-user'),
    path('users/activate/', users_views.ActivateUserView.as_view(), name='activate-user'),
...
urlpatterns += [
    ...
    path('pharmacy/medicines/barcode/', pharmacy_views.MedicineBarcodeSearchView.as_view(), name='pharmacy-medicine-barcode'),
    path('pharmacy/master-medicines/', pharmacy_views.MasterMedicineListCreateView.as_view(), name='pharmacy-master-medicines'),
    path('pharmacy/master-medicines/<int:pk>/', pharmacy_views.MasterMedicineDetailView.as_view(), name='pharmacy-master-medicine-detail'),
    ...
    path('pharmacy/prescriptions/<int:pk>/pdf/', pharmacy_views.PrescriptionPDFView.as_view(), name='pharmacy-prescription-pdf'),
    ...
    path('retail/products/barcode/', retail_views.ProductBarcodeSearchView.as_view(), name='retail-product-barcode'),
    ...
    # Education Dashboards New APIs
    path('education/assignments/', education_views.AssignmentViewSet.as_view({'get': 'list', 'post': 'create'}), name='education-assignments'),
    path('education/assignments/<int:pk>/', education_views.AssignmentViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='education-assignment-detail'),
    path('education/grades/', education_views.GradeViewSet.as_view({'get': 'list', 'post': 'create'}), name='education-grades'),
    path('education/grades/<int:pk>/', education_views.GradeViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='education-grade-detail'),
    path('education/principal-stats/', education_views.PrincipalStatsView.as_view(), name='education-principal-stats'),
]
