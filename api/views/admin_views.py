    ...
    def post(self, request):
        try:
            with transaction.atomic():
                ...
                Plan.objects.create(name="Free", description="Start for free, explore the platform.", max_users=2, storage_limit_mb=500, price=0, billing_cycle="monthly", has_dashboard=True, has_inventory=True)
                Plan.objects.create(name="Platform", description="For businesses with their own WhatsApp, SMS & Email setup.", max_users=10, storage_limit_mb=2048, price=999, billing_cycle="monthly", has_dashboard=True, has_inventory=True, has_api_access=True, has_billing=True, color="#00e676")
                Plan.objects.create(name="Starter", description="We set up your dedicated phone, WhatsApp & email.", max_users=15, storage_limit_mb=5120, price=2499, billing_cycle="monthly", has_dashboard=True, has_inventory=True, has_api_access=True)
                Plan.objects.create(name="Pro", description="Established orgs with advanced reporting.", max_users=50, storage_limit_mb=20480, price=6999, billing_cycle="monthly", popular=True, has_dashboard=True, has_inventory=True, has_api_access=True, has_analytics=True, has_priority_support=True)
                Plan.objects.create(name="Enterprise", description="Large scale, unlimited users, full BYOK.", max_users=None, storage_limit_mb=102400, price=14999, billing_cycle="monthly", has_dashboard=True, has_inventory=True, has_api_access=True, has_analytics=True, has_white_label=True, has_priority_support=True, has_custom_reports=True)
